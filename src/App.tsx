...
export default function App() {
  ...
  const handleShareWhatsApp = (title: string) => {
    const message = `Check out this memory from BoboBoy PHOTOS: ${title} ✨\n\nView the full collection here: ${window.location.href}`;
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        {[...Array(50)].map((_, i) => (
          <motion.div
            ...
            className="absolute w-[5px] h-[5px] bg-black/40 rounded-full blur-[1px] shadow-[0_0_15px_rgba(0,0,0,0.1)]"
          />
        ))}
      </div>
          ...
          >
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <h2 className="text-2xl font-black italic tracking-tight">About BoboBoy PHOTOS</h2>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 rounded-2xl text-sm text-gray-600 leading-relaxed">
                  BoboBoy PHOTOS is a premium digital gallery experience designed to showcase high-quality imagery with a refined, interactive interface. 
                </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="whitespace-nowrap overflow-hidden mask-fade">
                  <div className="whitespace-nowrap inline-block animate-marquee">
                    <span className="text-sm font-bold text-gray-900 pr-12">Cloudinary Memories Mix #3 - Special Edition</span>
                    <span className="text-sm font-bold text-gray-900 pr-12">Cloudinary Memories Mix #3 - Special Edition</span>
                  </div>
                </div>
              </div>
      ...
      <AnimatePresence>
        {selectedPhoto && (
          ...
          >
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-white">
                  <p className="text-[9px] font-black uppercase tracking-[0.4em] text-blue-500/80">Premium View</p>
            ...
            <div className="flex-grow flex items-center justify-center p-4 md:p-8 z-10 overflow-hidden">
            ...
            >
              ...
              <p className="text-[10px] text-white/40 mt-1 font-black uppercase tracking-[0.5em]">{selectedPhoto.category} • 2026 EDITION</p>
